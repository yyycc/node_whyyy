...
var sql = {
    ...
    updateDate: 'UPDATE y_blogs SET blog_updated_date=? WHERE blog_id=?',
    delete: 'DELETE FROM y_blogs WHERE blog_id=?',
    deleteAll: 'DELETE FROM y_blogs',
    queryById: 'SELECT * FROM y_blogs WHERE blog_id=?',
    queryAll: 'SELECT * FROM y_blogs',
    query: 'SELECT * FROM y_blogs',
